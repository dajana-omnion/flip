...
class CheckinCtrl extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['deskripsi_title'] = 'Choose available rooms';
    ...
    public function listCheckin()
    {
        ...
        $this->data['deskripsi_title'] = 'List of guests';
    ...
    public function show($id)
    {
        ...
        $this->data['deskripsi_title'] = 'Occupied rooms';
    ...
    public function edit($id)
    {
        //
        $this->data['title'] = 'Check In';
        $this->data['deskripsi_title'] = 'Guest data input';
