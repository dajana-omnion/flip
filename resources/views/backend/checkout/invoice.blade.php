...
<div class="row">
	<div class="col-sm-6">
		...
		<address>
			...
			<br>
			Phone number : {{$transaksi->tamu->nomor_telp}}<br>
		</address>
	</div>
	<div class="col-sm-6">
...
<div class="row">
	<div class="col-sm-6">
		<p class="text-muted well well-sm no-shadow">
			<b>Note :</b> Please keep this proof of payment as good as possible. The hotel will not serve guest complaints that do not have official payment receipt by the Hotel.
		</p>
	</div>
	<div class="col-sm-6">
		<table class="table table-bordered table-responsive">
			...
			<tr>
				<td><b>Sub-Total</b></td>
				<td class="pull-right">Eur {{number_format($sub_total,2)}}</td>
			</tr>
			<tr>
				<td>Tax 23%</td>
