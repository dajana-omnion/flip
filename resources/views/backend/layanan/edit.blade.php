...
<div class="box" id="layanan">
	<div class="box-header">
		<h3 class="box-title">Room bookings : 
			<b>{{$guest->kamar->nomor_kamar}}</b> - 
			<b>{{$guest->tamu->nama_lengkap}}</b>
		</h3>
		<a class="btn btn-warning pull-right" href="{{route('transaksilayanan.index')}}">Cancel</a>
	</div>
	<div class="box-body">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-name" id="myModalLabel">Service</h4>
              </div>
