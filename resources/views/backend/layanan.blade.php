        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <button class="btn btn-info" data-toggle="modal" data-target="#tambah-data">Add services</button>
              <div class="box-tools">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-name" id="myModalLabel">Add Data @{{dataBaru.nama_layanan}}</h4>
              </div>
