                ...
                <tr v-for="room in kamar.data">
                  ...
                  <td>
                    ...
                    <div v-else-if="room.status == 2">
                      <span class="label label-warning">Dirty</span>
                    </div>
                    <div v-else>
