                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6">
                          <label>Address</label>
                          <textarea class="form-control" name="password" placeholder="Address"  v-model="perusahaan.alamat_jalan">@{{perusahaan.alamat_jalan}}</textarea>
                           <span v-if="errorForm['password']" class="error text-danger">@{{ errorForm['password'] }}</span>
                        </div>
                        <div class="col-sm-3">
                          <label>City</label>
                          <input class="form-control" name="alamat_kabupaten" placeholder="City"  v-model="perusahaan.alamat_kabupaten">
                           <span v-if="errorForm['alamat_kabupaten']" class="error text-danger">@{{ errorForm['alamat_kabupaten'] }}</span>
                        </div>
                        <div class="col-sm-3">
                          <label>Country</label>
                          <input class="form-control" name="alamat_provinsi" placeholder="Country"  v-model="perusahaan.alamat_provinsi">
