          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-name" id="myModalLabel">Add Data @{{dataBaru.name}} @{{dataBaru.username}} @{{dataBaru.nama_belakang}}</h4>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                         <input class="form-control" name="Nama Pengguna" placeholder="User Name"  v-model="dataBaru.name">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                         <input class="form-control" name="Nama Pengguna" placeholder="Name"  v-model="dataEdit.name">
                          <span v-if="errorForm['name']" class="error text-danger">@{{ errorForm['name'] }}</span>
                        </div>
                        <div class="col-sm-6">
