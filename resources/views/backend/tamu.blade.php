        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <button class="btn btn-info" data-toggle="modal" data-target="#tambah-data">Add guests</button>
              <div class="box-tools">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th style="white-space: nowrap;">Guest name</th>
                  <th>Citizenship</th>
                  <th>Telephone</th>
                  <th>Email</th>
                  <th>Action</th>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-name" id="myModalLabel">Add Data @{{dataBaru.prefix}} @{{dataBaru.nama_depan}} @{{dataBaru.nama_belakang}}</h4>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <input class="form-control" name="nama_depan" placeholder="First name"  v-model="dataBaru.nama_depan">
                           <span v-if="errorForm['nama_depan']" class="error text-danger">@{{ errorForm['nama_depan'] }}</span>
                        </div>
                        <div class="col-sm-4">
                          <input class="form-control" name="nama_belakang" placeholder="Last nama"  v-model="dataBaru.nama_belakang">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <input class="form-control" name="nomor_identitas" placeholder="ID number"  v-model="dataBaru.nomor_identitas">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6">
                          <input class="form-control" name="alamat_kabupaten" placeholder="City" v-model="dataBaru.alamat_kabupaten">
                           <span v-if="errorForm['alamat_kabupaten']" class="error text-danger">@{{ errorForm['alamat_kabupaten'] }}</span>
                        </div>
                        <div class="col-sm-6">
                          <input class="form-control" name="alamat_provinsi" placeholder="Country" v-model="dataBaru.alamat_provinsi">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <input class="form-control" name="nama_depan" placeholder="First name"  v-model="dataEdit.nama_depan">
                           <span v-if="errorForm['nama_depan']" class="error text-danger">@{{ errorForm['nama_depan'] }}</span>
                        </div>
                        <div class="col-sm-4">
                          <input class="form-control" name="nama_belakang" placeholder="Last name"  v-model="dataEdit.nama_belakang">
                           <span v-if="errorForm['nama_belakang']" class="error text-danger">@{{ errorForm['nama_belakang'] }}</span>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <input class="form-control" name="nomor_identitas" placeholder="ID number"  v-model="dataEdit.nomor_identitas">
                           <span v-if="errorForm['nomor_identitas']" class="error text-danger">@{{ errorForm['nomor_identitas'] }}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6">
                          <input class="form-control" name="alamat_kabupaten" placeholder="City" v-model="dataEdit.alamat_kabupaten">
                           <span v-if="errorForm['alamat_kabupaten']" class="error text-danger">@{{ errorForm['alamat_kabupaten'] }}</span>
                        </div>
                        <div class="col-sm-6">
                          <input class="form-control" name="alamat_provinsi" placeholder="Country" v-model="dataEdit.alamat_provinsi">
                           <span v-if="errorForm['alamat_provinsi']" class="error text-danger">@{{ errorForm['alamat_provinsi'] }}</span>
                        </div>
                      </div>
                    </div>
        ...
        <div class="modal fade" id="hapus-data" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-name" id="myModalLabel">Delete Data</h4>
              </div>
              <div class="modal-body">
