...
class DashboardCtrl extends Controller
{
    ...
    public function index()
    {
    	...
    	$this->data['deskripsi_title'] = 'Welcome';
    	$this->data['kamar_tersedia'] = Kamar::where('status',0) -> orWhere('status',1)->count();
        $this->data['rooms_available'] = Kamar::where('status',0)->count();
