        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <button class="btn btn-info" data-toggle="modal" data-target="#tambah-data">Add a Service Category</button>
              <div class="box-tools">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  <th style="white-space: nowrap;">Service category name</th>
                  <th>Info</th>
                  <th>Actions</th>
                </tr>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-name" id="myModalLabel">Add Data @{{dataBaru.nama_layanan_kategori}}</h4>
              </div>
              <div class="modal-body">
                <div class="form-group">
                  <label for="name">Nama of the service category:</label>
